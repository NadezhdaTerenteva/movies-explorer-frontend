...
function AboutMe() {
  return (
    <section className="about-me">
      <h2 className="about-me__title"><a name="about-me">Студент</a></h2>
      <article className="about-me__description">
        <div className="about-me__info">
            ...
            <a href="https://github.com/NadezhdaTerenteva" target="blank" className="about-me__github-link">Github</a>
        </div>
